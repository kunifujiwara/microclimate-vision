...
class MCVisionDataset(Dataset):
    def __init__(self, args, process_type):
        ...
        if process_type == "train":
            self.data = pd.read_csv(args.training_data_path)
        elif process_type == "val":
            self.data = pd.read_csv(args.validation_data_path)
        elif process_type == "test":            
            self.data = pd.read_csv(args.test_data_path)

        data_s = pd.read_csv(args.sequence_data_path)
        ...
        if self.args.input_scaling:
            if args.dataset_standard == "train":
                data_standard = pd.read_csv(args.training_data_path)
